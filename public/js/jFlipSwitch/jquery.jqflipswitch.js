...
(function($) {
    ...
    var _create = function(element, settings) {
        ...
        if ($.isPlainObject(settings.texts)) {
            texts.left  = settings.texts.left  || '';
            texts.right = settings.texts.right || '';
        }
        ...
        // var textLeft      = $('<div class="' + UI_CLASSES.TEXT_LEFT  + '"></div>').html("<span class=\"material-symbols-outlined\">"+ texts.left +"</span>");
        // var textRight     = $('<div class="' + UI_CLASSES.TEXT_RIGHT + '"></div>').html("<span class=\"material-symbols-outlined\">"+ texts.right +"</span>")
